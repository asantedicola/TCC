         ...
         <div className="container w-25 m-5 p-3 bg-body-secondary rounded-5 border border-4 border-primary needs-validation"
            ...
            <form className="row g-3" id="institutionForm">
               ...
               <div className="col-12">
                  ...
                  <input type="text" className="form-control" id="slogan" placeholder="Slogan" required value={slogan}
                         onChange={(e) => setSlogan(e.target.value)}/>
               </div>
               <div className="col-12">
                  <label htmlFor="area" className="form-label">Área de Atuação</label>
                  <input type="text" className="form-control" id="area" placeholder="Área de Atuação" required
                         value={area_atuacao} onChange={(e) => setArea_atuacao(e.target.value)}/>
               </div>
               <div className="col-12">
                  <label htmlFor="email" className="form-label">Email</label>
                  <input type="email" className="form-control" id="email" placeholder="email@instituicao.com" required
                         value={email} onChange={(e) => setEmail(e.target.value)}/>
               </div>
               <div className="col-12">
                  <label htmlFor="address" className="form-label">Endereço</label>
                  <input type="text" className="form-control" id="address" placeholder="Rua, Número, Apt. CEP" required
                         value={endereco} onChange={(e) => setEndereco(e.target.value)}/>
               </div>
               <div className="col-12">
                  <label htmlFor="phonenumber" className="form-label">Telefone</label>
                  <input type="text" className="form-control" id="phonenumber" placeholder="(XX) 99999-0000"
                  ...
                  <button
                        ...
                        onClick={(e) => {
                           ...
                           if (form.checkValidity()) {
                              client.request(createItem("Instituicao", {
                                 area_atuacao,
                                 endereco,
                                 slogan,
                                 id_usuario: {
